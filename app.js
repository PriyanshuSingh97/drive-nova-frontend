...
function resetOAuthButtons() {
	const buttonsToReset = [{
		id: 'google-login-login',
		html: `<img src="https://res.cloudinary.com/dtvyar9as/image/upload/v1756950611/google-logo_qf8vsc.png" alt="Google"> <span>Continue with Google</span>`
	}, {
		id: 'google-login-register',
		html: `<img src="https://res.cloudinary.com/dtvyar9as/image/upload/v1756950611/google-logo_qf8vsc.png" alt="Google"> <span>Continue with Google</span>`
	}, {
		id: 'github-login-login',
		html: `<img src="https://res.cloudinary.com/dtvyar9as/image/upload/v1756950613/github-logo_l0mgoo.png" alt="GitHub"> <span>Continue with GitHub</span>`
	}, {
		id: 'github-login-register',
		html: `<img src="https://res.cloudinary.com/dtvyar9as/image/upload/v1756950613/github-logo_l0mgoo.png" alt="GitHub"> <span>Continue with GitHub</span>`
	}, ];

	buttonsToReset.forEach(config => {
...
function openLoginModal() {
	...
	if (loginModal) {
		resetOAuthButtons(); // <-- THIS IS THE FIX: Reset buttons every time the modal is opened.
